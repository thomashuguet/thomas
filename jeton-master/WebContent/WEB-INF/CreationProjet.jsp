...
<div class="container center_div">
    ...
    <form action="/Jeton/CreationProjet" method="POST">
        <div class="form-group">
            <label for="formGroupExampleInput">Nom projet</label>
            <input type="text" class="form-control" name="nomProjet" placeholder="Saisir un nom de projet">
        </div>
        <div class="form-group">
